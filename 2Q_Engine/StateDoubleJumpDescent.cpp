...
void StateDoubleJumpDescent::Enter()
{
	...
	pAnimationComponent->SetAnimation("DoubleJumpDescent", pFSMCharacter->m_bMirror, false);
	pAnimationComponent->SetFrameIndex(0);
}

void StateDoubleJumpDescent::Update(float dt)
{
...
void StateDoubleJumpDescent::Exit()
{
}

bool StateDoubleJumpDescent::CheckTransition(string& nextState)
{
	FSMCharacter* pFSMCharacter = dynamic_cast<FSMCharacter*>(m_pOwner);
